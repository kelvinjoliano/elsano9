    ...
    <div className='mt-12 flex gap-x-8 gap-y-16 justify-between flex-wrap'>
        <Link href="/" className='w-full flex flex-col gap-4 sm:w-[45%] lg:w-[22%]'>
            <div className='relative w-full h-80'>
                <Image src="https://static.jakmall.id/2020/08/images/products/f544c8/detail/xiaomi-redmi-powerbank-usb-type-c-20000-qi-fast-charge-10000mah.jpg" alt="" fill sizes="(max-width: 640px) 50vw, (max-width: 1024px) 25vw, 20vw" className='absolute object-cover rounded-md z-10 hover:opacity-0 transation-opacity easy duration-500'></Image>

                <Image src="https://static.jakmall.id/2020/08/images/products/ee6f76/detail/xiaomi-redmi-powerbank-usb-type-c-20000-qi-fast-charge-10000mah.jpg" alt="" fill sizes="(max-width: 640px) 50vw, (max-width: 1024px) 25vw, 20vw" className='absolute object-cover rounded-md'></Image>
            </div>
        ...
        <Link href="/" className='w-full flex flex-col gap-4 sm:w-[45%] lg:w-[22%]'>
            <div className='relative w-full h-80'>
                <Image src="https://static.jakmall.id/2024/10/images/products/1f7d9b/detail/wtotech-bantal-leher-pijat-u-shaped-pillow-3-massage-mode-2000mah-ump-021.jpg" alt="" fill sizes="(max-width: 640px) 50vw, (max-width: 1024px) 25vw, 20vw" className='absolute object-cover rounded-md z-10 hover:opacity-0 transation-opacity easy duration-500'></Image>

                <Image src="https://static.jakmall.id/2023/10/images/products/8b1d94/detail/wtotech-bantal-leher-pijat-u-shaped-pillow-3-massage-mode-2000mah-ump-021.jpg" alt="" fill sizes="(max-width: 640px) 50vw, (max-width: 1024px) 25vw, 20vw" className='absolute object-cover rounded-md'></Image>
            </div>
            <div className='flex justify-between flex-col gap-4'>
        ...
        <Link href="/" className='w-full flex flex-col gap-4 sm:w-[45%] lg:w-[22%]'>
            <div className='relative w-full h-80'>
                <Image src="https://static.jakmall.id/2023/09/images/products/209f54/detail/lescolton-mini-humidifier-aromatherapy-oil-diffuser-usb-250ml-hm25.png" alt="" fill sizes="(max-width: 640px) 50vw, (max-width: 1024px) 25vw, 20vw" className='absolute object-cover rounded-md z-10 hover:opacity-0 transation-opacity easy duration-500'></Image>

                <Image src="https://static.jakmall.id/2023/09/images/products/c70b3e/detail/lescolton-mini-humidifier-aromatherapy-oil-diffuser-usb-250ml-hm25.png" alt="" fill sizes="(max-width: 640px) 50vw, (max-width: 1024px) 25vw, 20vw" className='absolute object-cover rounded-md'></Image>
            </div>
            <div className='flex justify-between flex-col gap-4'>
        ...
        <Link href="/" className='w-full flex flex-col gap-4 sm:w-[45%] lg:w-[22%]'>
            <div className='relative w-full h-80'>
                <Image src="https://static.jakmall.id/2022/03/images/products/1050ec/detail/rhodey-kotak-jam-tangan-luxury-12-slot-z-0003.jpg" alt="" fill sizes="(max-width: 640px) 50vw, (max-width: 1024px) 25vw, 20vw" className='absolute object-cover rounded-md z-10 hover:opacity-0 transation-opacity easy duration-500'></Image>

                <Image src="https://static.jakmall.id/2022/03/images/products/60e8d7/detail/rhodey-kotak-jam-tangan-luxury-12-slot-z-0003.jpg" alt="" fill sizes="(max-width: 640px) 50vw, (max-width: 1024px) 25vw, 20vw" className='absolute object-cover rounded-md'></Image>
            </div>
            <div className='flex justify-between flex-col gap-4'>
